...
oDanfe:Say(nLine+230,MAXBOXH-30,"DATA ENTRADA/SAÍDA T",oFont08N:oFont)
oDanfe:Say(nLine+240,MAXBOXH-30,"",oFont08:oFont) //Iif( Empty(aDest[4]),"",ConvDate(aDest[4]) ),oFont08:oFont)
