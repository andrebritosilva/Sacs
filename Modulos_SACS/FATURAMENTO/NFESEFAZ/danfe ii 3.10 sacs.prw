...
//Irá verificar se precisa imprimir os termos do ativo
If lExistNFE

   U_PATFA02TER(MV_PAR01,MV_PAR02)
...
nQtdCxs := nPesoL := nPesoB := 0

If MV_PAR04 == 2
	
	nPesoL := nPesoB := nQtdCxs := 0
	
	dbSelectArea("SD2")
	dbSetOrder(3)
	MsSeek(xFilial("SD2")+SF2->F2_DOC+SF2->F2_SERIE+SF2->F2_CLIENTE+SF2->F2_LOJA)
	
	While SD2->(!Eof()) .And. xFilial("SF2")+SF2->F2_DOC+SF2->F2_SERIE+SF2->F2_CLIENTE+SF2->F2_LOJA == ;
		xFilial("SF2")+SD2->D2_DOC+SD2->D2_SERIE+SD2->D2_CLIENTE+SD2->D2_LOJA
...
While SD2->(!Eof()) .And. SF2->F2_DOC+SF2->F2_SERIE+SF2->F2_CLIENTE+SF2->F2_LOJA == SD2->D2_DOC+SD2->D2_SERIE+SD2->D2_CLIENTE+SD2->D2_LOJA 
   ...
   nPesq := Ascan(aPedidos,SD2->D2_PEDIDO)
   If nPesq == 0
...
If Len(aPedidos) > 0
   ...
   For nPed := 1 to Len(aPedidos)
       ...
       If nPed == 1
          cPedidos := "N.Pedido: "+aPedidos[nPed]
       Else
          cPedidos += "/"+aPedidos[nPed] 
       EndIf     
...
oDanfe:Say(326,202,Transform(SF2->F2_BRICMS,"@e 999,999,999.99"),oFont08:oFont)
...
oDanfe:Say(326,363,Transform(SF2->F2_ICMSRET,"@e 999,999,999.99"),oFont08:oFont)
...
If SF2->F2_DOC == "000005534"
oDanfe:Say(339,295,"OUTRAS DESPESAS ACESSÓRIAS",oFont08N:oFont)
oDanfe:Say(349,295,Transform(SF2->F2_VALIPI,"@E 999,999,999.99"),oFont08:oFont)
oDanfe:Box(330,414,353,500)
oDanfe:Say(339,420,"VALOR DO IPI",oFont08N:oFont)
//oDanfe:Say(349,420,aTotais[09],oFont08:oFont)
Else
oDanfe:Say(339,295,"OUTRAS DESPESAS ACESSÓRIAS",oFont08N:oFont)
oDanfe:Say(349,295,aTotais[10],oFont08:oFont)
oDanfe:Box(330,414,353,500)
oDanfe:Say(339,420,"VALOR DO IPI",oFont08N:oFont)
oDanfe:Say(349,420,aTotais[09],oFont08:oFont)
EndIf 
...
oDanfe:Say(349,506,Transform(SF2->F2_VALBRUT,"@E 999,999,999.99"),oFont08:oFont)
...
oDanfe:Say(428,002,Transform(SF2->F2_VOLUME1 ,"@E 999999"),oFont08:oFont)
oDanfe:Box(408,100,432,200)
oDanfe:Say(418,102,"ESPECIE",oFont08N:oFont)
If !Empty(aTransp[12])                        
   oDanfe:Say(428,102,aTransp[12],oFont08:oFont)
Else
   oDanfe:Say(428,102,"CAIXAS",oFont08:oFont)
EndIf 
   
//oDanfe:Say(428,102,Iif(,aTransp[12],Iif(Len(aEspVol)>0,aEspVol[1][1],"")),oFont08:oFont)
...
oDanfe:Say(428,402,Transform(SF2->F2_PBRUTO ,"@E 999999.9999"),oFont08:oFont)
//oDanfe:Say(428,402,Iif (!Empty(aEspVol[1][3]),Transform(val(aEspVol[1][3]),"@E 999999.9999"),Transform(nPesoB ,"@E 999999.9999")),oFont08:oFont)
oDanfe:Box(408,500,432,603)
oDanfe:Say(418,502,"PESO LIQUIDO",oFont08N:oFont)
oDanfe:Say(428,502,Transform(SF2->F2_PLIQUI ,"@E 999999.9999"),oFont08:oFont)
